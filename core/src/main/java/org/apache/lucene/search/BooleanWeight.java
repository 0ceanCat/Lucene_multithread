...
final class BooleanWeight extends Weight {
    ...
    protected static class WeightCreator implements Runnable {
        final IndexSearcher searcher;
        final List<WeightedBooleanClause> weights;
        final Query query;
        ...
        WeightCreator(IndexSearcher searcher,
                      Query query,
                      ScoreMode scoreMode,
                      float boost,
                      BooleanClause clause,
                      List<WeightedBooleanClause> weights,
        ...
        public void run() {
            try {
                Weight w = this.searcher.createWeight(query, scoreMode, boost);
                this.weights.add(new WeightedBooleanClause(clause, w));
    ...
    final List<WeightedBooleanClause> weightedClauses;
    final ScoreMode scoreMode;
